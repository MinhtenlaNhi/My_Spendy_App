...
import com.example.myspendyapp.databinding.FragmentCreateIncomeBinding
...
class CreateIncomeFragment : Fragment() {
    ...
    private fun setupCategoryDropdown() {
        ...
        categoryViewModel.allCategories.observe(viewLifecycleOwner) { allCategories ->
            ...
            android.util.Log.d("CreateIncomeFragment", "Categories loaded: ${categoryNames.size}")
    ...
    private fun saveIncomeTransaction() {
        ...
        val selectedCategory = incomeCategories.find { it.name == categoryName }
        ...
        try {
            ...
            val newTransaction = Transaction(
                ...
                isIncome = true // Đây là khoản thu
            )

            transactionViewModel.addTransaction(newTransaction)

            Toast.makeText(requireContext(), "Đã lưu khoản thu thành công", Toast.LENGTH_SHORT).show()
            findNavController().popBackStack()
